...
| 状态 | **P1 已实现并本地验收通过**(v0.3.0,commit `c94e3e0`,2026-09-11 用户确认)· P2 见 `P002-MCP直连方案.md` |
|---|---|
| 提案日期 | 2026-09-11 |
...
> **v0.5.0 安全模型勘误**:本文中的 token/鉴权条款已被 P004 零配置方案取代
> (127.0.0.1 + JSON CORS 预检防线),命令集与其余合同不变。见 `P003`/`P004` 提案。
